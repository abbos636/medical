<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MedicalOculist.Default" %>
...
<meta content="width=device-width, initial-scale=1.0" name="viewport">
    <title>Medical Oculist</title>

  <link href="assets/img/Wheel_icon-icons.com_54891.ico" rel="shortcut icon" type="image/x-icon" />
              ...
              <div id="topbar" class="d-flex align-items-center fixed-top">
                <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
                  <div class="align-items-center d-none d-md-flex">
                    <i class="bi bi-clock"></i> Понедельник - пятница с 8:00 до 19:00
                  </div>
                  <div class="d-flex align-items-center">
                    <i class="bi bi-phone"></i> Позвоните нам сейчас +99899 777 7777
                  </div>
                </div>
              </div>
            ...
            <main id="main">
                ...
                <section id="appointment" class="appointment section-bg">
                  <div class="container" data-aos="fade-up">
                    ...
                    <div action="forms/appointment.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
                      <div class="row">
